...
var userInput = prompt("Enter the unit");
var sur_Charge = prompt("Enter the surCharge price");
var electricity_Unit = Number(userInput);
var Charges_number = Number(sur_Charge);
...
if (electricity_Unit <= 50) {
    ...
    console.log("Your total bil is ".concat(totalBill));
}
